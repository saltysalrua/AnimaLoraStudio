...
| 0004 | [预处理状态用单 manifest 替代「双 bucket + per-image sidecar」](0004-preprocess-manifest.md) | Accepted (amended 2026-05-21；待 ADR 0010 accept 后转 Superseded) | 2026-05-15 |
...
| 0010 | [preprocess scope 从项目级 download 下沉到 version 级 train](0010-preprocess-train-scope.md) | Proposed | 2026-06-03 |
