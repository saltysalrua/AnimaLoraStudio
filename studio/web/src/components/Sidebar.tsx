...
const I = {
  ...
  extract: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M4 7h6"/><path d="M14 7h6"/><path d="M10 7a2 2 0 0 0 4 0 2 2 0 0 0-4 0"/><path d="M4 17h6"/><path d="M14 17h6"/><path d="M10 17a2 2 0 0 0 4 0 2 2 0 0 0-4 0"/><path d="M12 9v6"/></svg>,
  ...
  return (
    ...
    >
      ...
      <nav className={`flex-1 flex flex-col gap-0.5 overflow-hidden ${collapsed ? 'px-2 py-2.5' : 'px-2 py-3.5'}`}>
        ...
        <NavItem to="/tools/extract-lora" label={t('nav.extractLora')} icon={I.extract} active={isMain('/tools/extract-lora')} collapsed={collapsed} />
